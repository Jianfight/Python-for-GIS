...
def threeBandFusion(band1_fn, band2_fn, band3_fn):
...
band1_fn = input('please input Band1: ')
band2_fn = input('please input Band2: ')
band3_fn = input('please input Band3: ')

threeBandFusion(band1_fn, band2_fn, band3_fn)
